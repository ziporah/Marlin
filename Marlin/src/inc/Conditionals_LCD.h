...
// XPT2046_** Compatibility
  ...
  #if defined(XPT2046_X_CALIBRATION) && defined(XPT2046_Y_CALIBRATION) && defined(XPT2046_X_OFFSET) && defined(XPT2046_Y_OFFSET) && defined(XPT2046_ORIENTATION)
    ...
    #define TOUCH_ORIENTATION    XPT2046_ORIENTATION
  #endif
#endif
