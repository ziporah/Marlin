...
#define STRING_CONFIG_H_AUTHOR "(matosantos, ET5 Pro)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 114.01
  #define DEFAULT_bedKi 17.40
  #define DEFAULT_bedKd 498.15
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -23, -10, -0.76 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 23              // Set Mesh bounds as an inset region of the bed
